...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($nama) || empty($username) || empty($password)) {
        ...
        try {
            ...
            if(isset($_FILES['foto'])) {
                ...
                if(in_array($ext, $allowed_types)) {
                    if($file['size'] <= 2 * 1024 * 1024) { // 2MB max
                        $new_filename = uniqid('staf_', true) . '.' . $ext;
            ...
            $stmt = $conn->prepare("INSERT INTO staf 
            ...
            if($stmt->execute()) {
                ...
                echo "<script>setTimeout(() => window.location.href = 'staf.php?pesan=sukses', 2000)</script>";
            }
        } catch(Exception $e) {
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Tambah staf</h5>
                            <div class="card">
                                <div class="card-body">
                                    <?php echo $pesan; ?>
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nama" name="nama" aria-describedby="namaHelp" placeholder="Masukkan Nama" value="<?php echo $nama; ?>" required>
                                        </div>
                                        <div class="mb-3">
